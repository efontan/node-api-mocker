 ...
 * @param {[]} success Responses for successfull requests
 * @param {[]} error Responses for unsuccessfull requests
 * @param {number} failQuote Failingrate of the server
 */
function Router(success, error, failQuote) {
     ...
     * It will either way use an respone from responseSuccess or responseError
     * @param {object} req
     * @param {object} res
     */
